"""
Configuration for Qwen-1.5B model experiments.
"""
...
DATA_CONFIG = DataConfig(
    ...
    supported_models=["DeepSeek-R1-Distill-Qwen-1_5B", "qwen-1.5b", "qwen_1_5b"]
)

# Complete experiment configurations
QWEN_1_5B_LINEAR_EXPERIMENT = ExperimentConfig(
...
QWEN_1_5B_POLYNOMIAL_EXPERIMENT = ExperimentConfig(
    model_config=MODEL_CONFIG,
    hardware_config=JETSON_HARDWARE,
...
QWEN_1_5B_RF_EXPERIMENT = ExperimentConfig(
    model_config=MODEL_CONFIG,
    hardware_config=JETSON_HARDWARE,
